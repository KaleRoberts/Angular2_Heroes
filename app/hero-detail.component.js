        ...
        execute: function() {
            HeroDetailComponent = (function () {
                ...
                HeroDetailComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var id = +this._routeParams.get('id'); // Hero id is a number, and route params are always strings. Have to do type conversion here with the + operator in front of this._routeParams
